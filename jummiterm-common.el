...
(defcustom jummiterm-theme-org-agenda-height nil
...
(defcustom jummiterm-theme-org-height t
  "Use varying text heights for org headings."
  :type 'boolean
  :group 'jummiterm-theme)

(defcustom jummiterm-theme-org-bold t
  "Inherit text bold for org headings"
  :type 'boolean
  :group 'jummiterm-theme)

(defcustom jummiterm-theme-org-priority-bold t
  "Inherit text bold for priority items in agenda view"
  :type 'boolean
  :group 'jummiterm-theme)

(defcustom jummiterm-theme-org-highlight nil
  "Highlight org headings."
  :type 'boolean
  :group 'jummiterm-theme)

(defcustom jummiterm-theme-custom-colors nil
  "Specify a list of custom colors."
  :type 'alist
  :group 'jummiterm-theme)

(defcustom jummiterm-theme-underline-parens t
...
(defun custom-colors-override ()
  (mapcar (lambda (x) (list (car x) (cdr x)))
          jummiterm-theme-custom-colors))

(defun create-jummiterm-theme (variant theme-name)
...
;;;;; basics
     ...
     `(font-lock-comment-face ((,class (:foreground ,(if jummiterm-theme-comment-italic comment-light comment) :background ,(when jummiterm-theme-comment-bg comment-bg) :slant ,(if jummiterm-theme-comment-italic 'italic 'normal)))))
     `(font-lock-constant-face ((,class (:foreground ,const))))
     `(font-lock-doc-face ((,class (:foreground ,meta))))
     `(font-lock-function-name-face ((,class (:foreground ,func :inherit bold))))
     `(font-lock-keyword-face ((,class (:inherit bold :foreground ,keyword :slant ,(if jummiterm-theme-keyword-italic 'italic 'normal)))))
...
;;;;; latex
     ...
     `(font-latex-sectioning-0-face ((,class (:inherit bold :foreground ,head3 :height ,(if jummiterm-theme-org-height 1.3 1.0) :background ,(when jummiterm-theme-org-highlight head3-bg)))))
     `(font-latex-sectioning-1-face ((,class (:inherit bold :foreground ,head4 :height ,(if jummiterm-theme-org-height 1.3 1.0) :background ,(when jummiterm-theme-org-highlight head4-bg)))))
     `(font-latex-sectioning-2-face ((,class (:inherit bold :foreground ,head1 :height ,(if jummiterm-theme-org-height 1.3 1.0) :background ,(when jummiterm-theme-org-highlight head1-bg)))))
     `(font-latex-sectioning-3-face ((,class (:inherit bold :foreground ,head2 :height ,(if jummiterm-theme-org-height 1.2 1.0) :background ,(when jummiterm-theme-org-highlight head2-bg)))))
     `(font-latex-sectioning-4-face ((,class (:bold nil :foreground ,head3 :height ,(if jummiterm-theme-org-height 1.1 1.0) :background ,(when jummiterm-theme-org-highlight head3-bg)))))
     `(font-latex-sectioning-5-face ((,class (:bold nil :foreground ,head4 :background ,(when jummiterm-theme-org-highlight head4-bg)))))
...
;;;;; markdown
     `(markdown-header-face-1 ((,class (:inherit bold :foreground ,head1 :height ,(if jummiterm-theme-org-height 1.3 1.0) :background ,(when jummiterm-theme-org-highlight head1-bg)))))
     `(markdown-header-face-2 ((,class (:inherit bold :foreground ,head2 :height ,(if jummiterm-theme-org-height 1.2 1.0) :background ,(when jummiterm-theme-org-highlight head2-bg)))))
     `(markdown-header-face-3 ((,class (:bold nil :foreground ,head3 :height ,(if jummiterm-theme-org-height 1.1 1.0) :background ,(when jummiterm-theme-org-highlight head3-bg)))))
     `(markdown-header-face-4 ((,class (:bold nil :foreground ,head4 :background ,(when jummiterm-theme-org-highlight head4-bg)))))
...
;;;;; org
     ...
     `(org-agenda-date ((,class (:foreground ,var :height ,(if jummiterm-theme-org-agenda-height 1.1 1.0)))))
     `(org-agenda-date-today ((,class (:foreground ,keyword :inherit bold :height ,(if jummiterm-theme-org-agenda-height 1.3 1.0)))))
     `(org-agenda-date-weekend ((,class (:inherit bold :foreground ,var))))
     `(org-agenda-done ((,class (:foreground ,suc :height ,(if jummiterm-theme-org-agenda-height 1.2 1.0)))))
     ...
     `(org-document-title ((,class (:foreground ,func :inherit bold :height ,(if jummiterm-theme-org-height 1.4 1.0) :underline t))))
     ...
     `(org-level-1 ((,class (:inherit bold :bold ,(if jummiterm-theme-org-bold 'unspecified nil) :foreground ,head1 :height ,(if jummiterm-theme-org-height 1.3 1.0) :background ,(when jummiterm-theme-org-highlight head1-bg)))))
     `(org-level-2 ((,class (:inherit bold :bold ,(if jummiterm-theme-org-bold 'unspecified nil) :foreground ,head2 :height ,(if jummiterm-theme-org-height 1.2 1.0) :background ,(when jummiterm-theme-org-highlight head2-bg)))))
     `(org-level-3 ((,class (:bold nil :foreground ,head3 :height ,(if jummiterm-theme-org-height 1.1 1.0) :background ,(when jummiterm-theme-org-highlight head3-bg)))))
     `(org-level-4 ((,class (:bold nil :foreground ,head4 :background ,(when jummiterm-theme-org-highlight head4-bg)))))
     ...
     `(org-priority ((,class (:foreground ,war :inherit bold :bold ,(if jummiterm-theme-org-priority-bold 'unspecified nil)))))
     `(org-quote ((,class (:inherit org-block :slant italic))))
     `(org-scheduled ((,class (:foreground ,comp))))
     `(org-scheduled-today ((,class (:foreground ,func :height ,(if jummiterm-theme-org-agenda-height 1.2 1.0)))))
...
;;;;; show-paren
     `(show-paren-match ((,class (:foreground ,mat :inherit bold  :underline ,(when jummiterm-theme-underline-parens t)))))
     `(show-paren-match-expression ((,class (:background ,green-bg-s))))
     `(show-paren-mismatch ((,class (:foreground ,err :inherit bold :underline ,(when jummiterm-theme-underline-parens t)))))

;;;;; smartparens
     `(sp-pair-overlay-face ((,class (:background ,highlight :foreground nil))))
     `(sp-show-pair-match-face ((,class (:foreground ,mat :inherit bold  :underline ,(when jummiterm-theme-underline-parens t)))))
...
(provide 'jummiterm-common)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; jummiterm-common.el ends here
